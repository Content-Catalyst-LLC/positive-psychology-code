...
fn main() {
    let values = [7.4, 7.6, 7.0, 7.2, 6.9, 7.3, 7.1, 7.0, 6.9, 3.2];
    let weights = [0.13, 0.13, 0.12, 0.12, 0.12, 0.13, 0.10, 0.10, 0.10, -0.05];

    match dot(&values, &weights) {
        Ok(score) => println!("Future well-being index: {:.3}", score),
