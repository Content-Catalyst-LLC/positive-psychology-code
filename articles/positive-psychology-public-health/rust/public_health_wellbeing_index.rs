...
fn main() {
    let values = [7.4, 7.6, 7.3, 7.2, 7.5, 7.4, 7.6, 7.3, 7.1, 7.3, 3.0];
    let weights = [0.11, 0.12, 0.10, 0.10, 0.11, 0.10, 0.09, 0.10, 0.09, 0.10, -0.10];

    match dot(&values, &weights) {
        Ok(score) => println!("Public health well-being index: {:.3}", score),
